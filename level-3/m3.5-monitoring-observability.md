...
![Observability](m3.5-monitoring-observability.diagram1.png)
...
class BusinessMetricsAgent(AgentBase):
    ...
    def transfer(self, args: dict, raw_data: dict = None) -> SwaigFunctionResult:
        ...
        return (
            ...
            .connect(get_dept_number(department), final=True)
        )
...
**Next:** [Module 3.6 - Troubleshooting](m3.6-troubleshooting)
