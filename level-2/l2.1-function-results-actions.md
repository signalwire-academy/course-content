---
layout: default
title: "Lab 2.1: Function Results and Actions"
...
<a href="https://classroom.github.com/a/xLmv1FCN" target="_blank"><strong>Accept this assignment on GitHub Classroom</strong></a> to get your own repository.
</p>
...
Create a new file `lab2_1_actions.py`.
...
def confirm_appointment(
    ...
    return (
        ...
        .add_action("send_sms", {
            "to_number": phone,
            "message": f"Appointment confirmed: {date} at {time}"
        })
...
def schedule_callback(
    ...
    return (
        ...
        }, post_process=True)  # Happens after AI finishes speaking
    )
```
...
def escalate_call(self, args: dict, raw_data: dict = None) -> SwaigFunctionResult:
    ...
    return (
        ...
        .add_action("set_meta_data", {"escalation_reason": reason})
        .add_action("transfer", {
            "dest": "+15551234567"
        }, post_process=True)
    )
