...
<strong>🎯 Assignment:</strong> <a href="https://classroom.github.com/a/vQmId_pO" target="_blank"><strong>Accept this lab on GitHub Classroom</strong></a><br>
...
Recording is enabled via constructor parameters:

```python
super().__init__(
    name="payment-agent",
    record_call=True,       # Enable recording
    record_format="mp3",    # MP3 format
    record_stereo=True      # Separate caller/agent channels
)
```
...
![Payment Flow](l2.7-call-recording.diagram1.png)
...
**Next:** [Lab 2.8 - Call Transfer](l2.8-call-transfer)
