...
<a href="https://classroom.github.com/a/ATU8XfDy" target="_blank"><strong>Accept this assignment on GitHub Classroom</strong></a> to get your own repository.
</p>


**Duration:** 45 minutes
**Prerequisites:** Module 2.7 completed

## Objectives

- Configure call recording settings
- Implement recording consent flow
- Pause/resume for sensitive data

## Setup

Create a new file `lab2_7_recording.py`.
...
def handle_consent(args: dict, raw_data: dict = None) -> SwaigFunctionResult:
    ...
    if consent_given == "yes":
        return (
            ...
            .add_action("set_meta_data", {"recording_consent": True})
            .add_action("toggle_record", {"state": "start"})
        )
    else:
        return (
            SwaigFunctionResult(
            ...
            .add_action("set_meta_data", {"recording_consent": False})
        )
```
...
```python
#!/usr/bin/env python3
"""Lab 2.7: Call recording with PCI-compliant payment collection."""
...
class PaymentAgent(AgentBase):
    def __init__(self):
        ...
        self.prompt_add_section(
            "Role",
            "You process payments. Disclose recording at call start."
        )
    ...
    def _setup_functions(self):
        @self.tool(description="Handle recording consent", parameters={
            "type": "object",
            "properties": {
                "consent_given": {"type": "string", "enum": ["yes", "no"]}
            },
            "required": ["consent_given"]
        })
        def handle_consent(args: dict, raw_data: dict = None) -> SwaigFunctionResult:
            ...
            if consent_given == "yes":
                return (
                    SwaigFunctionResult("Thank you. How can I help?")
                    .update_global_data({"recording_consent": True})
                    .record_call(control_id="main", stereo=True, format="mp3")
                )
            return (
                SwaigFunctionResult("Okay, not recording. How can I help?")
