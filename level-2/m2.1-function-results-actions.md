...
| Method | Purpose |
|--------|---------|
| `.connect(dest, final, from_number)` | Transfer call to number/SIP URI |
| `.swml_transfer(url)` | Transfer to a SWML URL or section |
...
.connect("+15551234567", final=True, from_number="+15559876543")

# Transfer to SIP address
.connect("sip:support@company.com", final=True)

# Transfer to another SWML document/URL
.swml_transfer("https://example.com/billing-agent.swml")
```
...
**Next:** [Module 2.2 - DataMap Integration](m2.2-datamap-integration)
