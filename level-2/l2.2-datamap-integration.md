---
layout: default
title: "Lab 2.2: DataMap Integration"
...
<a href="https://classroom.github.com/a/Deb7MXfr" target="_blank"><strong>Accept this assignment on GitHub Classroom</strong></a> to get your own repository.
</p>
...
- Configure DataMap for external API calls
- Transform API responses for voice output
- Handle API errors gracefully

## Setup

You'll need a test API. We'll use JSONPlaceholder (free, no auth required).

Create a new file `lab2_2_datamap.py`.
