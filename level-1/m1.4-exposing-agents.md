...
![SignalWire  X>    Firewall    X>   Your Agent](m1.4-exposing-agents.diagram1.png)
...
![New SWML Script                                          ...](m1.4-exposing-agents.diagram2.png)
...
![← Back to Resources](m1.4-exposing-agents.diagram3.png)

1. Click the **Addresses & Phone Numbers** tab
2. Click **+ Add**

![Add an Address                                           ...](m1.4-exposing-agents.diagram4.png)
...
**Next:** [Module 1.5 - Prompt Engineering for Voice](m1.5-prompt-engineering)
