...
<strong>📝 Take Exam:</strong> <a href="https://classroom.github.com/a/jFD8thkh" target="_blank"><strong>Start Level 1 Written Exam</strong></a><br>
...
Which class is the foundation for all SignalWire agents?
...
When a call arrives at your agent, what does SignalWire request?
...
What is the purpose of the `ai` verb in SWML?
...
What happens when a user asks something that requires a function call?
...
Which of these is NOT a SignalWire platform component?
...
What must every SWML document include?
...
Why is ngrok useful for agent development?
...
What is the primary purpose of basic authentication on your agent?
...
What is the minimum code needed to create a working agent?
...
Which method adds a prompt section to an agent?
...
What do "fillers" do in a voice agent?
...
Which code correctly configures voice?
...
What is wrong with this prompt for a voice agent?
...
What command generates SWML from an agent file?
...
Which is a valid language code?
...
What is the class-based agent pattern best for?
...
What decorator creates a SWAIG function?
...
What parameter is REQUIRED in the @tool decorator?
...
What must a SWAIG function return?
...
How does the AI know when to call a specific function?
...
What does this parameter definition create?
...
How do you test a function without making a call?
...
What is the purpose of function fillers?
...
Which is a valid enum parameter definition?
...
What command lists all functions in an agent?
...
What happens when a function returns an error message in SwaigFunctionResult?
