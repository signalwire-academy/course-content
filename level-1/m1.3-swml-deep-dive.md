...
#### Play with Multiple Sources

The `play` verb supports a `urls` array with multiple source types:
...
| URL Prefix | Purpose |
|------------|---------|
| `https://...` | Play audio file |
| `say: text` | Text-to-speech |
| `silence: seconds` | Insert silence |
| `ring:seconds:region` | Play ring tone |
...
| `play` | Play audio/TTS | `url`, `urls`, `volume` |
...
**Next:** [Module 1.4 - Exposing Agents](m1.4-exposing-agents)
